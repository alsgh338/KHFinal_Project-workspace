...
INSERT INTO NOTICE
VALUES (SEQ_NNO.NEXTVAL, '공지서비스 이용 안내', 'admin', '게시판서비스는 회원만 이용할 수 있습니다. 회원 가입하세요.', '20190201');
...
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, '세번째 게시글', 'admin', 'JDBC는 자바랑 오라클을 연동시켜주는 기술입니다.', NULL, NULL, DEFAULT, DEFAULT, DEFAULT);

INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, '네번째 게시글', 'admin', '웹의 3요소는 html, css, javascript 입니다!', NULL, NULL, DEFAULT, DEFAULT, DEFAULT);
...
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, '여덟번째 게시글', 'user01', 'jQuery 는 자바스크립트의 복잡한 문법을 대체 가능합니다.', NULL, NULL, DEFAULT, DEFAULT, DEFAULT);
...
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, '열다섯번째 게시글', 'admin', '열심히 공부하세요.', NULL, NULL, DEFAULT, DEFAULT, DEFAULT);
