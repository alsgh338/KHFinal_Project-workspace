...
COMMENT ON COLUMN MEMBER.ADDRESS_NO IS '우편번호';
...
CREATE TABLE PRODUCT_IMG (
    ...
    PRODUCT_IMG_PATH VARCHAR2(1000) NOT NULL UNIQUE,
...
CREATE TABLE PRODUCT_REVIEW (
    ...
    REVIEW_IMG_PATH VARCHAR2(1000),
    REVIEW_IMG_ORIGIN VARCHAR2(1000),
    REVIEW_IMG_CHANGE VARCHAR2(1000),
...
COMMENT ON COLUMN PRODUCT_REVIEW.REVIEW_IMG_PATH IS '저장경로';
COMMENT ON COLUMN PRODUCT_REVIEW.REVIEW_IMG_ORIGIN IS '리뷰 원본 이미지';
COMMENT ON COLUMN PRODUCT_REVIEW.REVIEW_IMG_CHANGE IS '리뷰 변경 이미지';
...
CREATE TABLE CLASS_REGIST(
    ...
    REGIST_PAYCODE NUMBER NOT NULL,
    STATUS CHAR(1) DEFAULT 'Y' CHECK(STATUS IN ('Y','N')),
...
COMMENT ON COLUMN CHAT_MEM.CHAT_NO IS '채팅방 번호';
