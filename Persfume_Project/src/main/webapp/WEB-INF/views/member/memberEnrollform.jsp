...
<jsp:include page="../common/header.jsp"/>
    ...
    <div id="outer">
        ...
        <form action="" method="post" id="EnrollForm">
            <table  id="mem_info" class="table_css">
                ...
                <tr>
                    ...
                    <td colspan="4">
                        ...
                        <input type="text" id="memPhone_1" maxlength="4" style="width: 100px;">
                        <input type="text" id="memPhone_2" maxlength="4" style="width: 100px;">
                ...
                <tr>
                    <td colspan="4">
                        <input type="text" id="roadAddress" name="roadAddress" placeholder="도로명주소" style="width: 100%;">
                    </td>
                </tr>
                <tr>
                    <td colspan="4">
                        <input type="text" id="jibunAddress" name="jibunAddress" placeholder="지번주소" style="width: 100%;">
                    </td>
                </tr>
                <tr>
                    <td colspan="4">
                        <input type="text" id="detailAddress" name="detailAddress" placeholder="상세주소" style="width: 100%;">
                    </td>
                </tr>
            ...
            <br>
            <br>
            <table border="1" id="mem_info" class="table_css">
                <tr>
                ...
                <tr>
                    <th>이메일 </th>
                    <td colspan="4">
                        <input type="email" id="memName" name="memName">
                        (예 : user01@naver.com)
                        <button type="button">인증번호 전송</button>
                    </td>
                </tr>
                    ...
                    <tr>
                        <td colspan="2"> 
                            <fieldset >
                               ...
                               ②"몰"이 제3자에게 구매자 개인정보를 제공•위탁할 필요가 있는 경우 실제 구매신청 시 구매자의 동의를 받아야 하며, 회원가입 시 미리 포괄적으로 동의를 받지 않습니다. 이 때 "몰"은 제공되는 개인정보 항목, 제공받는 자, 제공받는 자의 개인정보 이용 목적 및 보유‧이용 기간 등을 구매자에게 명시하여야 합니다. 다만 「정보통신망이용촉진 및 정보보호 등에 관한 법률」 제26조 제1항에 의한 개인정보 취급위탁의 경우 등 관련 법령에 달리 정함이 있는 경우에는 그에 따릅니다.
                               ...
                               ①"몰"과 재화 등의 "몰"은 이용자로부터 재화 등을 반환 받은 경우 3영업일 이내에 이미 지급받은 재화 등의 대금을 환급합니다. 이 경우 “몰”이 이용자에게 재화 등의 환급을 지연한 때에는 그 지연기간에 대하여 「전자상거래 등에서의 소비자보호에 관한 법률 시행령」제21조의 2에서 정하는 지연이자율을 곱하여 산정한 지연이자를 지급합니다.
                               ...
                               “주식회사 퍼퓸그라피”은 회원가입, 주문안내, 배송안내 등 비광고성 정보를 카카오톡 알림톡으로 알려드리며, 만약 알림톡 수신이 불가능하거나 수신 차단하신 경우에는 일반 문자메시지로 보내드립니다. 카카오톡 알림톡을 통해 안내되는 정보를 와이파이가 아닌 이동통신망으로 이용할 경우, 알림톡 수신 중 데이터 요금이 발생할 수 있습니다. 카카오톡을 통해 발송되는 알림톡 수신을 원치 않으실 경우 반드시 알림톡을 차단하여 주시기 바랍니다.
                               
                               #카카오톡 상담톡 시행에 관한 내용
                               
                               “주식회사 퍼퓸그라피”은 상담업무를 카카오톡 상담톡으로 진행하며, 만약 카카오톡을 통해 안내되는 상담 내용을 Wi-Fi 나 PC가 아닌 이동통신망으로 이용할 경우, 데이터 요금이 발생할 수 있습니다. 카카오톡을 통해상담을 원치 않으실 경우 고객센터, 게시판 문의를 이용해 주시기 바랍니다
                               
                                
                               
                               부 칙(시행일) 이 약관은 2016년 8월 10일부터 시행합니다.
        ...
        <button type="submit" id="enroll_btn" onclick="">회원가입</button>
